...
`nanashiwang` が保守する独立した派生版です。MIT License に基づき [farion1231/cc-switch](https://github.com/farion1231/cc-switch) を利用しています。
...
> 以下は上流由来の情報であり、YuanHeng Switch との提携を示すものではありません。
