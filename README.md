...
This is an independent derivative maintained by `nanashiwang`, based on [farion1231/cc-switch](https://github.com/farion1231/cc-switch) under the MIT License.

English | [中文](README_ZH.md) | [日本語](README_JA.md) | [Deutsch](README_DE.md) | [Changelog](CHANGELOG.md)

</div>

## Upstream Partner Information

> The following information is inherited from upstream for compatibility and attribution. It does not imply a partnership with YuanHeng Switch.
