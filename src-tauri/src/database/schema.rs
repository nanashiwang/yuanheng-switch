...
impl Database {
    ...
    fn migrate_v2_to_v3(conn: &Connection) -> Result<(), AppError> {
        ...
        // 说明：v3 结构将 Skills 的 SSOT 迁移到 ~/.yuanheng-switch/skills/，
    ...
    fn seed_model_pricing(conn: &Connection) -> Result<(), AppError> {
        let pricing_data = [
            ...
            // OpenAI Standard reference pricing, verified 2026-09-11:
            // https://developers.openai.com/api/docs/models/gpt-6-astra
            // Long-context rates are attached by the shared pricing resolver.
