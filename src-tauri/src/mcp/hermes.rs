...
//!
//! Handles conversion between YuanHeng Switch unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | YuanHeng Switch unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// YuanHeng Switch has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: YuanHeng Switch -> Hermes
// ============================================================================

/// Convert YuanHeng Switch unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> YuanHeng Switch
// ============================================================================

/// Convert Hermes format to YuanHeng Switch unified format
///
/// Conversion rules:
...
/// `existing` — this prevents YuanHeng Switch from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive YuanHeng Switch round-trip"
        );
    }
