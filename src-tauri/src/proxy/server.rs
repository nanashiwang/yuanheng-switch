...
impl ProxyServer {
    ...
    fn build_router(&self) -> Router {
        Router::new()
            ...
            .route(
                "/chatgpt-desktop/v1/responses",
                post(handlers::handle_chatgpt_desktop_responses),
            )
            ...
            .route(
                "/chatgpt-desktop/v1/responses/compact",
                post(handlers::handle_chatgpt_desktop_responses_compact),
            )
            .route(
